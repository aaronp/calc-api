...
enum ServiceResponse[+A]:
  ...
  case Other(code: Int, description: Option[String], headers: Map[String, String] = Map.empty)
      extends ServiceResponse[Nothing]
...
object ServiceResponse {
  ...
  def apply[A](code: Int, description: String = ""): ServiceResponse[A] =
    Other(code, Option(description.trim).filterNot(_.isEmpty))
